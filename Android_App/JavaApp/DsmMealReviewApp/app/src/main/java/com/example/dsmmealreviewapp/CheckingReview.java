...
public class CheckingReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checking_review);
        ...
        btn_setGPA1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(GPA != 0) {
                    setStar = true;
                    finish();
                } else Toast.makeText(CheckingReview.this, "급식 리뷰를 진행해주세요!", Toast.LENGTH_SHORT).show();;
            }
        });
        ...
        btn_setGPA2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CheckingReview.this, AddReview.class));
            }
        });
